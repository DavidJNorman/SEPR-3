...
public class Attack {
	...
	//sea monster attacks
	public static Attack attackBite = new Attack("Bite","Bite player ship",3,2,false,90);
	public static Attack attackTail = new Attack("Tail Whip","Attack player ship with tail",2,2,false,90);
